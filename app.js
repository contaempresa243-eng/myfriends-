...
function abrirVibracaoModal() {
  const atual = window.localStorage.getItem('myfriens_notif_vibracao_' + currentChatId) || 'predefinicao';
...
function selecionarVibracao(id) {
  window.localStorage.setItem('myfriens_notif_vibracao_' + currentChatId, id);
  document.getElementById('notif-vibracao-label').innerText = opcoesVibracao.find((o) => o.id === id).nome;
...
function abrirToqueNotificacao() {
  const atual = window.localStorage.getItem('myfriens_notif_toque_' + currentChatId) || 'predefinido';
...
function selecionarToque(id, nome) {
  window.localStorage.setItem('myfriens_notif_toque_' + currentChatId, id);
  document.getElementById('notif-toque-label').innerText = nome;
  abrirToqueNotificacao(); // redesenha para atualizar o marcador selecionado
}
